...
#define GPIOTE_OUT_0 (*(volatile unsigned long int*)(GPIOTE_BASE_ADDRESS + 0x000))
#define GPIOTE_IN_0 (*(volatile unsigned long int*)(GPIOTE_BASE_ADDRESS + 0x100))
#define CONFIG_1 (*(volatile unsigned long int*)(GPIOTE_BASE_ADDRESS + 0x514))
#define GPIOTE_OUT_1 (*(volatile unsigned long int*)(GPIOTE_BASE_ADDRESS + 0x004))
#define GPIOTE_IN_1 (*(volatile unsigned long int*)(GPIOTE_BASE_ADDRESS + 0x104))
